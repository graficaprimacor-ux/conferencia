...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 p-4">
      <div className="w-full max-w-md text-center bg-white rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12">
        <img src="/logo.png" alt="Primacor Gráfica Logo" className="w-48 sm:w-64 mx-auto mb-8" />
        <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">Sistema de Conferência</h1>
